...
function custom_styles_core()
{
    ...
    $item_breadcrump = get_theme_mod( 'font_breadcrump_page_title', array() );

    if(isset($item_breadcrump['font-family'])){
        $breadcrump_font_family = "font-family: ".esc_attr($item_breadcrump['font-family']).";";
    }else{
        $breadcrump_font_family = "";
    }

    if($item_breadcrump['variant'] == "100"){
        $value_item_breadcrump = "font-weight:100;";
    }else if($item_breadcrump['variant'] == "100italic"){
        $value_item_breadcrump = "font-weight:100; font-style:italic;";
    }else if($item_breadcrump['variant'] == "200"){
        $value_item_breadcrump = "font-weight:200;";
    }else if($item_breadcrump['variant'] == "200italic"){
        $value_item_breadcrump = "font-weight:200; font-style:italic;";
    }else if($item_breadcrump['variant'] == "300"){
        $value_item_breadcrump = "font-weight:300;";
    }else if($item_breadcrump['variant'] == "300italic"){
        $value_item_breadcrump = "font-weight:300; font-style:italic;";
    }else if($item_breadcrump['variant'] == "regular"){
        $value_item_breadcrump = "font-weight:400;";
    }else if($item_breadcrump['variant'] == "italic"){
        $value_item_breadcrump = "font-weight:400; font-style:italic;";
    }else if($item_breadcrump['variant'] == "500"){
        $value_item_breadcrump = "font-weight:500;";
    }else if($item_breadcrump['variant'] == "500italic"){
        $value_item_breadcrump = "font-weight:500; font-style:italic;";
    }else if($item_breadcrump['variant'] == "600"){
        $value_item_breadcrump = "font-weight:600;";
    }else if($item_breadcrump['variant'] == "600italic"){
        $value_item_breadcrump = "font-weight:600; font-style:italic;";
    }else if($item_breadcrump['variant'] == "700"){
        $value_item_breadcrump = "font-weight:700;";
    }else if($item_breadcrump['variant'] == "700italic"){
        $value_item_breadcrump = "font-weight:700; font-style:italic;";
    }else if($item_breadcrump['variant'] == "800"){
        $value_item_breadcrump = "font-weight:800;";
    }else if($item_breadcrump['variant'] == "800italic"){
        $value_item_breadcrump = "font-weight:800; font-style:italic;";
    }else if($item_breadcrump['variant'] == "900"){
        $value_item_breadcrump = "font-weight:900;";
    }else if($item_breadcrump['variant'] == "900italic"){
        $value_item_breadcrump = "font-weight:900; font-style:italic;";
    }

    if(isset($item_breadcrump['font-size'])){
        $breadcrump_font_size = "font-size: ".esc_attr($item_breadcrump['font-size'])."";
    }else{
        $breadcrump_font_size = "";
    }

    if(isset($item_breadcrump['text-transform'])){
        $breadcrump_text_transform = "text-transform: ".esc_attr($item_breadcrump['text-transform'])."";
    }else{
        $breadcrump_text_transform = "";
    }

    if(isset($item_breadcrump['color'])){
        $breadcrump_color = "color: ".esc_attr($item_breadcrump['color'])."";
    }else{
        $breadcrump_color = "";
    }
    ...
    $item_title = get_theme_mod( 'font_title_page_title', array() );

    if(isset($item_title['font-family'])){
        $title_font_family = "font-family: ".esc_attr($item_title['font-family'])." !important;";
    }else{
        $title_font_family = "";
    }

    if($item_title['variant'] == "100"){
        $value_item_title = "font-weight:100;";
    }else if($item_title['variant'] == "100italic"){
        $value_item_title = "font-weight:100; font-style:italic;";
    }else if($item_title['variant'] == "200"){
        $value_item_title = "font-weight:200;";
    }else if($item_title['variant'] == "200italic"){
        $value_item_title = "font-weight:200; font-style:italic;";
    }else if($item_title['variant'] == "300"){
        $value_item_title = "font-weight:300;";
    }else if($item_title['variant'] == "300italic"){
        $value_item_title = "font-weight:300; font-style:italic;";
    }else if($item_title['variant'] == "regular"){
        $value_item_title = "font-weight:400;";
    }else if($item_title['variant'] == "italic"){
        $value_item_title = "font-weight:400; font-style:italic;";
    }else if($item_title['variant'] == "500"){
        $value_item_title = "font-weight:500;";
    }else if($item_title['variant'] == "500italic"){
        $value_item_title = "font-weight:500; font-style:italic;";
    }else if($item_title['variant'] == "600"){
        $value_item_title = "font-weight:600;";
    }else if($item_title['variant'] == "600italic"){
        $value_item_title = "font-weight:600; font-style:italic;";
    }else if($item_title['variant'] == "700"){
        $value_item_title = "font-weight:700;";
    }else if($item_title['variant'] == "700italic"){
        $value_item_title = "font-weight:700; font-style:italic;";
    }else if($item_title['variant'] == "800"){
        $value_item_title = "font-weight:800;";
    }else if($item_title['variant'] == "800italic"){
        $value_item_title = "font-weight:800; font-style:italic;";
    }else if($item_title['variant'] == "900"){
        $value_item_title = "font-weight:900;";
    }else if($item_title['variant'] == "900italic"){
        $value_item_title = "font-weight:900; font-style:italic;";
    }

    if(isset($item_title['font-size'])){
        $title_font_size = "font-size: ".esc_attr($item_title['font-size']).";";
    }else{
        $title_font_size = "";
    }

    if(isset($item_title['text-transform'])){
        $title_text_transform = "text-transform: ".esc_attr($item_title['text-transform']).";";
    }else{
        $title_text_transform = "";
    }

    if(isset($item_title['color'])){
        $title_color= "color: ".esc_attr($item_title['color']).";";
    }else{
        $title_color = "";
    }
   ...
   if(get_theme_mod('garenal_back_to_top') == true){
    ...
    if(!empty(get_theme_mod('layout_background_header5'))){
        $layout_background_header5 = "background: ".esc_attr(get_theme_mod('layout_background_header5'))." !important;";
    }else{
        $layout_background_header5 = "";
    }
    ...
    if(!empty(get_theme_mod('layout_background_header1_style2'))){
        $layout_background_header1_style2 = "background: ".esc_attr(get_theme_mod('layout_background_header1_style2')).";";
    }else{
        $layout_background_header1_style2 = "";
    }

    if(!empty(get_theme_mod('layout_background_header1_style3'))){
        $layout_background_header1_style3 = "background: ".esc_attr(get_theme_mod('layout_background_header1_style3')).";";
    }else{
        $layout_background_header1_style3 = "";
    }
    ...
    //Main menu header 1 (home default)
    if(!empty(get_theme_mod('header1_v1_style1'))){
        $header1_v1_style1 = "color: ".esc_attr(get_theme_mod('header1_v1_style1'))." !important;";
    }else{
        $header1_v1_style1 = "";
    }

    if(!empty(get_theme_mod('header1_v1_style2'))){
        $header1_v1_style2 = "color: ".esc_attr(get_theme_mod('header1_v1_style2'))." !important;";
    }else{
        $header1_v1_style2 = "";
    }

    if(!empty(get_theme_mod('header1_v1_style3'))){
        $header1_v1_style3_border = "border-color: ".esc_attr(get_theme_mod('header1_v1_style3'))." !important;";
        $header1_v1_style3 = "background-color: ".esc_attr(get_theme_mod('header1_v1_style3'))." !important;";
    }else{
        $header1_v1_style3_border = "";
        $header1_v1_style3 = "";
    }
    ...
    echo "<style>
            ...
            .vk-header2 .item-search i:hover{
             ...
             @media screen and (max-width:991px){
                ...
                .page-id-2345 .vk-header1 .vk-navbar-nav > li > a{
                    color:#FFF !important;
                }
            ...
            .page-id-18 .vk-header1 .content:after{
                ".$header1_v1_style3."
            }
            .page-id-18 .vk-header1 .vk-navbar-header{
                ".$header1_v1_style3_border."
            }
            .page-id-18 .vk-header1 .vk-navbar{
                ".$header1_v1_style3_border."
            }
            .page-id-18 .vk-header1 .vk-navbar-nav > li > a{
                ".$header1_v1_style1.";
            }
            .page-id-18 .vk-header1 .vk-navbar-nav > li > a:hover{
                ".$header1_v1_style2.";
            }
            ...
            .vk-breadcrumb ul li , a{
                ".$breadcrump_font_family."; ".$value_item_breadcrump."; ".$breadcrump_font_size."; ".$breadcrump_text_transform."; ".$breadcrump_color.";
            }
            
            .entry-title{
                ".$hideline_page_title."; ".$title_font_family." ; ".$value_item_title." ; ".$title_font_size." ; ".$title_text_transform." ; ".$title_color." ;
            }
...
function google_fonts_breacrumb(){
    $item_breadcrump = get_theme_mod( 'font_breadcrump_page_title', array() );
    wp_register_style( 'font_breacrumb',  'https://fonts.googleapis.com/css?family='.$item_breadcrump['font-family'].':100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i', 'all' );
    wp_enqueue_style( 'font_breacrumb' );

    $item_title = get_theme_mod( 'font_title_page_title', array() );
    wp_register_style( 'font_title',  'https://fonts.googleapis.com/css?family='.$item_title['font-family'].':100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i', 'all' );
    wp_enqueue_style( 'font_title' );
    ...
    $typography_main_menu_header = get_theme_mod( 'typography_main_menu_header', array() );
    wp_register_style( 'font_main_menu',  'https://fonts.googleapis.com/css?family='.$typography_main_menu_header['font-family'].':100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i', 'all' );
    wp_enqueue_style( 'font_main_menu' );
}
